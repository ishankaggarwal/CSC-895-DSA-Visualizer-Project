...
export class BinaryTree {
  ...
  createNodesAndLinks(
    ...
    this.createNodesAndLinks(
      root.left,
      row + 1,
      column - Math.pow(2, height - row - 1),
      height
    );
    this.createNodesAndLinks(
      root.right,
  ...
  createLinks(nodesWidthAndHeight: NodeWidthAndHeight[]) {
    let links: Link[] = [];
    let nodesWidthAndHeightMap: Map<number, NodeWidthAndHeight> = new Map<
      number,
      NodeWidthAndHeight
    >();
  ...
  createLinkTrees(
    ...
    parent: Node | null,
    links: Link[],
    nodesWidthAndHeightMap: Map<number, NodeWidthAndHeight>
  ) {
    if (root === null) {
      return;
    }
    ...
    if (
      ...
      if (root.left) {
        ...
        if (
          positionLeftX !== undefined &&
          positionLeftY !== undefined &&
          leftWidth !== undefined &&
      ...
      if (root.right) {
        ...
        if (
          positionRightX !== undefined &&
          positionRightY !== undefined &&
