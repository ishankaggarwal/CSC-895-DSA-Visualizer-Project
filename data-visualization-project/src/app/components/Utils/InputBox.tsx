        ...
        Papa.parse(file, {
          complete: (result) => {
            ...
            try {
              ...
              alert(
                "Please make sure the CSV file only contains numeric values and only one column"
              );
            }
          },
    ...
    >
      ...
      <OverlayTrigger
        ...
        overlay={(props) =>
          renderTooltip(
            props,
            "File must contain only 1 column, and it should only contain numeric values"
          )
        }
      >
