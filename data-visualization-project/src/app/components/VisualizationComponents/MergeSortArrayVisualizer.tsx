...
import { BinaryTree, BinaryTreeAnimationInterface, Link, Node } from "../Utils/BinaryTree";
...
import { DivideAndConquerArray, NodeTree } from "../Utils/DivideAndConquerArrayTree";
...
const MergeSortVisualizer = () =>{
    ...
    const createTree = (arr:number[])=>{
        ...
        const arrayTree = new DivideAndConquerArray(arr);
